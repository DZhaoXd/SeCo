...
This involves partitioning the unlabeled data into two subsets (one as a labeled subset and the other as an unlabeled subset) and employing a semi-supervised method (https://github.com/LiheYoung/UniMatch) for further adaptation, as mentioned in the paper.
